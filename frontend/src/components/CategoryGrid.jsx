        ...
        <section className="category-grid-section">
            <div className="category-grid-container">
                ...
                <div className="category-grid-layout">
                    {/* Clothing - Large */}
                    <Link to="/products?category=clothing" className="category-item item-clothing delay-100">
                    ...
                    {/* Accessories - Wide */}
                    <Link to="/products?category=accessories" className="category-item item-accessories delay-200">
                    ...
                    {/* Bags */}
                    <Link to="/products?category=bags" className="category-item item-bags delay-300">
                    ...
                    {/* Watches */}
                    <Link to="/products?category=watches" className="category-item item-watches delay-400">
