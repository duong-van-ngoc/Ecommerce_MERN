        ...
        <div id="dashboard-content" className="dashboard-content">
            ...
            <div className="flex justify-between items-end mb-12">
                <div>
                    ...
                    <p className="font-label text-xs uppercase tracking-widest text-[#92484f]">Chào mừng trở lại, {user?.name || "Quản trị viên"}</p>
                </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 border border-[#dfbfc0]/10 h-full flex flex-col justify-between text-left relative overflow-hidden" 
                         ...
                         <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h4 className="font-headline text-lg font-bold text-[#1a1c1b]">Trợ lý phối đồ AI</h4>
                                    <p className="font-label text-[10px] uppercase tracking-tighter text-[#ee5a6f]">Hệ thống gợi ý thông minh</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center p-3 bg-[#fef2f3] rounded-xl border border-[#fee2e2]">
                                    <span className="text-xs font-medium text-[#ee5a6f]">Sản phẩm nổi bật</span>
